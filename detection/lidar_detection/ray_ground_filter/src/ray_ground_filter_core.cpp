...
RayGroundFilter::RayGroundFilter(ros::NodeHandle &nh):nh(nh),above_points(new pcl::PointCloud<pcl::PointXYZI>()){}
...
bool RayGroundFilter::init_param(){
    ...
    nh.param<std::string>("no_ground_full_height_topic",no_ground_full_height_topic,"/ray_filter/points_no_ground_full_height");
    ...
    std::cout << "no_ground_full_height_topic: " << no_ground_full_height_topic << std::endl;
    std::cout << std::endl;
