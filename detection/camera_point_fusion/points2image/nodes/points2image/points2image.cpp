...
//#include "smartcar_msgs/CameraExtrinsic.h"
...
static void projection_callback(const smartcar_msgs::ProjectionMatrix& msg)
{
...
static void callback(const sensor_msgs::PointCloud2ConstPtr& msg)
{
  ...
  smartcar_msgs::PointsImage pub_msg = pointcloud2_to_image(msg, cameraExtrinsicMat, cameraMat, distCoeff, imageSize);
  pub.publish(pub_msg);
}
...
int main(int argc, char* argv[])
{
  ...
  pub = n.advertise<smartcar_msgs::PointsImage>(pub_topic_str, 10);
  ...
  ros::Subscriber intrinsic = n.subscribe("/camera_info", 1, intrinsic_callback);
