...
static smartcar_msgs::ProjectionMatrix extrinsic_matrix_msg_;
...
int main(int argc, char *argv[])
{
	...
	projection_matrix_pub = n.advertise<smartcar_msgs::ProjectionMatrix>(projection_matrix_topic, 10, true);
