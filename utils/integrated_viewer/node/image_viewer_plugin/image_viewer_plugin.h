...
#include "smartcar_msgs/ImageObjRanged.h"
#include "smartcar_msgs/ImageObjTracked.h"
...
namespace integrated_viewer
{
  ...
  protected:
    ...
    void DetectedObjCallback(const smartcar_msgs::DetectedObjectArray::ConstPtr &msg);
    void PointCallback(const smartcar_msgs::PointsImage::ConstPtr &msg);
    void LaneCallback(const smartcar_msgs::ImageLaneObjects::ConstPtr& msg);
  ...
  private:
    ...
    smartcar_msgs::PointsImage::ConstPtr points_msg_;
    smartcar_msgs::DetectedObjectArray::ConstPtr detected_objects_msg_;
    smartcar_msgs::ImageLaneObjects::ConstPtr lane_msg_;
