...
namespace integrated_viewer
{
    ...
    void DrawRects::DrawImageRect(const smartcar_msgs::DetectedObjectArray::ConstPtr &detected_objects,
                                  cv::Mat &image)
    {
    ...
    void DrawRects::DrawImageBox(const smartcar_msgs::DetectedObjectArray::ConstPtr &detected_objects,
                                 cv::Mat &image)
    {
        if (detected_objects == NULL)
        {
    ...
    void DrawRects::DrawLabel(const smartcar_msgs::DetectedObject &in_detected_object,
                              cv::Mat &image)
    {
