...
namespace integrated_viewer {
    ...
    const QString     ImageViewerPlugin::kDetectedObjectDataTypeBase    = "smartcar_msgs/DetectedObjectArray";
    const QString     ImageViewerPlugin::kPointDataType                 = "smartcar_msgs/PointsImage";
    const QString     ImageViewerPlugin::kLaneDataType                  = "smartcar_msgs/ImageLaneObjects";
    ...
    ImageViewerPlugin::ImageViewerPlugin(QWidget *parent)
        ...
        // Load default image
        default_image_ = cv::imread( DEFAULT_PATH + "smartcar_logo.png");
    ...
    void ImageViewerPlugin::on_rect_topic_combo_box__activated(int index) {
        ...
        rect_sub_ = node_handle_.subscribe<smartcar_msgs::DetectedObjectArray>(selected_topic,
                                                                     1,
    ...
    void ImageViewerPlugin::DetectedObjCallback(const smartcar_msgs::DetectedObjectArray::ConstPtr &msg) {
    ...
    void ImageViewerPlugin::on_point_topic_combo_box__activated(int index) {
        ...
        // if selected topic is not blank or empty , start callback function
        point_sub_ = node_handle_.subscribe<smartcar_msgs::PointsImage>(selected_topic,
                                                                        1,
    ...
    void ImageViewerPlugin::PointCallback(const smartcar_msgs::PointsImage::ConstPtr &msg) {
        points_msg_ = msg;
    } // ImageViewerPlugin::PointCallback()
    ...
    void ImageViewerPlugin::on_lane_topic_combo_box__activated(int index) {
        ...
        lane_sub_ = node_handle_.subscribe<smartcar_msgs::ImageLaneObjects>(selected_topic,
                                                                            1,
    ...
    void ImageViewerPlugin::LaneCallback(const smartcar_msgs::ImageLaneObjects::ConstPtr &msg) {
        lane_msg_ = msg;
    }
