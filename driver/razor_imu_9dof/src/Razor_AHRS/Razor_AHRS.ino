...
float ACCEL_Y_MIN = -248;
float ACCEL_Y_MAX = 271;
float ACCEL_Z_MIN = -275;
float ACCEL_Z_MAX = 232;

// Magnetometer (standard calibration mode)
// "magn x,y,z (min/max) = X_MIN/X_MAX  Y_MIN/Y_MAX  Z_MIN/Z_MAX"
float MAGN_X_MIN = -332;
float MAGN_X_MAX = 766;
float MAGN_Y_MIN = -614;
float MAGN_Y_MAX = 643;
float MAGN_Z_MIN = -646;
float MAGN_Z_MAX = 524;
...
boolean CALIBRATION__MAGN_USE_EXTENDED = false;
float magn_ellipsoid_center[3] = {36.3820, 18.9725, -46.6831};
float magn_ellipsoid_transform[3][3] = {{0.866905, -0.0843746, 0.0641489}, {-0.0843746, 0.909560, -0.0320205}, {0.0641489, -0.0320205, 0.826096}};


// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
float GYRO_AVERAGE_OFFSET_X = -48.64;
float GYRO_AVERAGE_OFFSET_Y = 36.05;
float GYRO_AVERAGE_OFFSET_Z = -6.17;
